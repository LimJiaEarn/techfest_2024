        ...
        {isEditingEmail ? (
          <div className="flex items-center">
            <input
              ...
              className="border border-gray-400 px-3 py-1 rounded mr-2 bg-gray-700 text-white focus:outline-none w-full"
            />
            <button
      ...
      <div className="mb-4 mt-6">
        ...
        {isEditingSkills ? (
          <div className="flex items-center">
            <input
              type="text"
              value={curSkills.join(",")}
              onChange={(e) => setCurSkills(e.target.value.split(","))}
              className="border border-gray-400 px-3 py-1 rounded mr-2 bg-gray-700 text-white focus:outline-none w-full"
            />
            <button
              className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600"
        ...
        {isEditingEducation ? (
          <div className="flex items-center">
            <input
              type="text"
              value={curEducation}
              onChange={(e) => setCurEducation(e.target.value)}
              className="border border-gray-400 px-3 py-1 rounded mr-2 bg-gray-700 text-white focus:outline-none w-full"
            />
            <button
              className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600"
      ...
      <div className="mb-4 mt-6">
        ...
        {isEditingWorkExperience ? (
          <div className="flex items-center">
            <input
              type="text"
              value={curWorkExperience}
              onChange={(e) => setCurWorkExperience(e.target.value)}
              className="border border-gray-400 px-3 py-1 rounded mr-2 bg-gray-700 text-white focus:outline-none w-full"
            />
            <button
              className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600"
