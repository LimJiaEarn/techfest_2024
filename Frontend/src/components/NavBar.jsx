...
import {
  navbarlinks_signedin,
  navbarlinks_signedout,
    ...
    <nav className="w-full flex py-4 justify-between items-center max-h-100 fixed top-0 z-50 bg-black1">
          ...
          ? navbarlinks_signedout.map((nav, index) => (
              <li
                ...
                className={`cursor-pointer text-18px ${
                  ...
                  index === navbarlinks_signedout.length - 1
                    ? "mr-[120px]"
                    : "mr-10"
                }`}
              ...
              nav.title !== "Sign Out" ? (
                <li
                  ...
                  className={`cursor-pointer text-18px ${
                    ...
                    index === navbarlinks_signedin.length - 1
                      ? "mr-[120px]"
                      : "mr-10"
                  }`}
                  onClick={() => setCurrentPage(nav.title)}
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        <div
          className={`${
            !toggle ? "hidden" : "flex"
          } p-6 bg-grey4 absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-xl`}
        >
