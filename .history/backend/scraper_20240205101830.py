...
def scrape_article_ids(api_url, max_pages):
    ...
    return job_id, titles, companies, locations, categories, subCategories, job_types, salaries
...
job_id, titles, companies, locations, categories, subCategories, job_types, salaries = scrape_article_ids(api_url, max_pages)
