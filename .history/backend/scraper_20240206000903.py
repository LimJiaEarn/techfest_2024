...
class JobScrapper(object):
    ...
    def scrape_and_store_text(self):
        ...
        data['job_title'] = self.titles
        data['company'] = self.companies
        data['location'] = self.locations 
        data['category'] = self.categorys
        data['subcategory'] = self.subCategorys
        data['type'] = self.job_types
        data['salary'] = self.salarys
